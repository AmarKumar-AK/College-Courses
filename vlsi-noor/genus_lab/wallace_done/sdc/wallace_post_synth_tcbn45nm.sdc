...
#  Created by Encounter(R) RTL Compiler v14.10-s022_1 on Wed Aug 10 22:06:16 +0530 2016
...
create_clock -name "clk" -period 0.05 -waveform {0.0 0.025} 
...
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[0]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[4]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[5]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[6]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[7]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[8]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[9]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[10]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[11]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[12]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[13]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[14]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.02 [get_ports {result[15]}]
