...
set dir /home/iiitdm/Desktop/log/Amar/fullAdder_done
set myFiles [list RCA64bit.v] ;# All your HDL files
set basename RCA64bit;# name of top level module
set myClk clk ;# clock name
set myPeriod_ps 5000 ;# Clock period in ps - MHz
set myInDelay_ps  1700 ;# delay from clock to inputs valid - 0.1 ns
set myOutDelay_ps 1700 ;# delay from clock to output valid - 0.1 ns
