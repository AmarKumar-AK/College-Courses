...
set dir /home/iiitdm/Desktop/log/Amar/wallace_done
set myFiles [list wallace.v] ;# All your HDL files
set basename wallace;# name of top level module
set myClk clk ;# clock name
set myPeriod_ps 50 ;# Clock period in ps - MHz
set myInDelay_ps  20 ;# delay from clock to inputs valid - 0.1 ns
set myOutDelay_ps 20 ;# delay from clock to output valid - 0.1 ns
