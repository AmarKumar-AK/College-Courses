...
Curve_3 = G2-G3
h=5.5
c1_plt =plt_eq(Curve_1, (X_new_point[0][0], -h, h),(X_new_point[1][0], -h, h),show=False)
c2_plt =plt_eq(Curve_2, (X_new_point[0][0], -h, h),(X_new_point[1][0], -h, h),show=False,line_color="red")
c3_plt =plt_eq(Curve_3, (X_new_point[0][0], -h, h),(X_new_point[1][0], -h, h),show=False,line_color="green") 

c1_plt.extend(c2_plt)
c1_plt.extend(c3_plt)

plt.scatter(iris.data[:50,2:3],iris.data[:50,3:4],cmap="blue")
plt.scatter(iris.data[50:100,2:3],iris.data[50:100,3:4],cmap="red")  
plt.scatter(iris.data[100:150,2:3],iris.data[100:150,3:4],cmap="green")      
c1_plt.show()