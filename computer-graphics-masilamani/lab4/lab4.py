...
for i in range(1,513):
    for j in range(1,513):
        error_b1[i][j] = (error_b1[i][j] + error_b1[i+1][j] + error_b1[i][j+1] + error_b1[i+1][j+1] + error_b1[i-1][j] + error_b1[i][j-1] + error_b1[i-1][j-1] + error_b1[i-1][j+1] + error_b1[i+1][j-1])/9
        error_b2[i][j] = (error_b2[i][j] + error_b2[i+1][j] + error_b2[i][j+1] + error_b2[i+1][j+1] + error_b2[i-1][j] + error_b2[i][j-1] + error_b2[i-1][j-1] + error_b2[i-1][j+1] + error_b2[i+1][j-1])/9
