# temp=[[0, 91883, 4], [1, 96210, 5], [2, 96215, 6], [3, 96347, 8], [4, 96380, 7]]
# # def sortSecond(val):
#     # return val[2]
...
# print(temp)
################################################################################
# new=[[1, 0, 1], [2, 3, 5], [3, 4, 2], [4, 8, 8], [5, 10, 3], [6, 11, 4]]
# count=0
# for a,b,c in new:
#     if(c==0):
#         count=count+1
...
#         a.plot(v,range(2 +max(x)),color='red')
#         a.plot(p, range(2 +max(x)),color='blue')
#         # a.invert_yaxis()

#         # a.set_title ("Estimation Grid", fontsize=16)
#         # a.set_ylabel("Time", fontsize=14)
...
#         self.Button_k.bind('<Button-1>',self.kmean)
...
#         # self.Listbox1.place(relx=0.479, rely=0.161, relheight=0.326
#         #         , relwidth=0.503)
...
#         toolbar = NavigationToolbar2Tk(Canvas12, self)
#         toolbar.update()
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Canvas1=tk.Canvas(self.Frame1)
        self.Canvas1.place(relx=0.455,rely=0.4,relheight=0.6,relwidth=0.56)
        self.Canvas1.configure(borderwidth="2")
        self.Canvas1.configure(relief="ridge")
        self.Canvas1.configure(selectbackground="#c4c4c4")
